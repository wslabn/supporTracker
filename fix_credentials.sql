-- Drop and recreate asset_credentials table with new structure
...
-- Insert default credential categories (ignore if already exist)
INSERT IGNORE INTO credential_categories (name, description) VALUES
