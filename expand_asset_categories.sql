-- Expand Asset Categories for Software and Services
USE supporttracker;
...
ADD COLUMN vendor VARCHAR(100) AFTER make,
ADD COLUMN version VARCHAR(50) AFTER model,
ADD COLUMN expiration_date DATE AFTER warranty_expires,
